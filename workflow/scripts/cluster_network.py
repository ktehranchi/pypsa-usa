...
def distribute_clusters(
    ...
    assert n_clusters >= len(n_subnetwork_nodes), (
        f"Number of clusters must be at least {len(n_subnetwork_nodes)} for this selection of countries."
    )
    assert n_clusters <= n_subnetwork_nodes.sum(), (
        f"Number of clusters must be at most {n_subnetwork_nodes.sum()} for this selection of countries."
    )
